import random
RED = '\033[31m'        # Rouge pour le texte
GREEN = '\033[32m'      # Vert pour le texte
YELLOW = '\033[33m'     # Jaune pour le texte
BLUE = '\033[34m'       # Bleu pour le texte
RESET = '\033[0m'       # Réinitialise la couleur (par défaut)
